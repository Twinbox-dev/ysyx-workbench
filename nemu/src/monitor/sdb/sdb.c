...
static int cmd_info(char* args){
    ...
    if (strcmp(arg, "r") == 0) {
        ...
        printf("Unknown info argument '%s' (supported: r, w)\n", arg);
    }
...
static struct {
    ...
    { "info", "Display information: info r for registers, info w for watchpoints", cmd_info },
